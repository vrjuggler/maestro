...
class Ui_MaestroBase(object):
   def setupUi(self, MaestroBase):
      ...
      self.mViewTitleFrame = QtGui.QFrame(self.centralwidget)
      self.mViewTitleFrame.setFrameShape(QtGui.QFrame.StyledPanel)
      self.mViewTitleFrame.setFrameShadow(QtGui.QFrame.Sunken)
      self.mViewTitleFrame.setObjectName("mViewTitleFrame")

      self.vboxlayout = QtGui.QVBoxLayout(self.mViewTitleFrame)
      self.vboxlayout.setMargin(0)
      self.vboxlayout.setSpacing(0)
      self.vboxlayout.setObjectName("vboxlayout")

      self.mViewTitleLbl = QtGui.QLabel(self.mViewTitleFrame)
      ...
      self.vboxlayout.addWidget(self.mViewTitleLbl)
      self.gridlayout.addWidget(self.mViewTitleFrame,0,1,1,1)
